    ...
    def dp_find_best_row(pieces, max_width):
        ...
        for i in range(1, n + 1):
            ...
            for prev_w, (total, items) in dp[i - 1].items():
                ...
                # Keep previous state (without including this item)
        ...
        row = [item[:4] for item in best_items]  # remove index
...
if __name__ == "__main__":
    ...
    #     ("9", "37 3/8", False), ("9", "37 3/8", False), ("9", "37 3/8", False), ("9", "37 3/8", False),
    #     ("12", "37 3/8", False), ("12", "37 3/8", False), ("12", "46 3/8", False), ("9", "46 3/8", False)
    # ]
    ...
    ("6 1/2", "16 1/2", False), ("19 1/2", "6 1/2", False), ("6 1/2", "16 1/2", False), ("4 1/2", "13 1/2", False),
    ("6 1/2", "16 1/2", False), ("19 1/2", "6 1/2", False), ("6 1/2", "16 1/2", False), ("6 1/2", "16 1/2", False),
    ("6 1/2", "16 1/2", False), ("19 1/2", "6 1/2", False), ("6 1/2", "16 1/2", False), ("6 1/2", "16 1/2", False),
